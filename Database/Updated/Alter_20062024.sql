...
Add EmployeeId	Varchar(100)

Alter Table EnrollmentForm
Add ReplacementEmployeeId	Varchar(100)

Alter Table EnrollmentForm
Add ReplacementBeneficiaryCode	Varchar(155)

Alter Table EnrollmentForm
Add EnrollmentStatus Varchar(55)
...
Alter Table M_DigitalService
Add ServiceURL Varchar(255)

Alter Table UserLogin
Add EnrollmentId INT 

Update M_DigitalCategory SET IsDeleted=1
Update M_DigitalService SET IsDeleted=1
...
----Select * From M_DigitalCategory Where Category='PM Welfare Schemes'
--Update M_DigitalCategory SET Category='Central G2C Services - PM Welfare Schemes',DisplayOrder=2 Where Category='PM Welfare Schemes'
