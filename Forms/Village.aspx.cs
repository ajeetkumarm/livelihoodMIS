...
public partial class Forms_Village : System.Web.UI.Page
{
    ...
    {
        VillageId = Request.QueryString["VillageId"] != null ? Convert.ToInt32(Request.QueryString["VillageId"]) : 0;
        if (!IsPostBack)
        {
            FetchState(0);
            if(VillageId>0)
        ...
        try
        {
            ...
            else
            {
                ...
                if (x > 0)
                {
                    ...
                    Response.Redirect("~/Forms/VillageList.aspx");
                }
                else
                {
                    ScriptManager.RegisterStartupScript(this, this.GetType(), "Message", "alert('System Error !');", true);
    ...
    protected void GetVillageDetail()
    {
        try
        {
